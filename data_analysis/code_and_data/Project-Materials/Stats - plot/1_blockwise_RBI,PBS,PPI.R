...
ggsave("1_blockwise-PPI.png", width = 6, height = 4, dpi = 1000)
...
ggsave("1_blockwise-RBI.png", width = 6, height = 4, dpi = 1000)
...
ggsave("1_blockwise-PBS.png", width = 6, height = 4, dpi = 1000)
